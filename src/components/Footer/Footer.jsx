    ...
    <footer className="mt-auto mx-auto container p-4 pt-10 ">
      ...
      <div className="text-center text-gray-300 ">
        ...
        <p className='text-base'>
          Built with ❤️ by <a href="https://github.com/KrishRio21" target='_blank' className='text-secondary font-medium hover:underline'>K𝖗𝖎𝖘𝖍</a>
        </p>
      </div>
    </footer>
  )
