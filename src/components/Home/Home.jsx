...
function Home() {
  ...
  return (
    <>
      <section className='home-hero-section pt-32 pb-20 relative max-w-full overflow-hidden'>
        ...
        <div className='container flex flex-wrap md:flex-nowrap justify-between items-center mx-auto my-10 gap-4 px-4'>
          <div className='relative'>
            <h1 className='text-2xl font-cairo font-semibold tracking-wide'>
              Hello World! <span className='emoji-wave' role='img' aria-labelledby='wave'>👋</span> I am
            </h1>
            <span className='text-secondary text-[42px] font-extrabold font-cairo tracking-wide relative sm:whitespace-normal whitespace-nowrap'>
              ...
              <span className='glow'>Sreepada Mohana Krishna</span>
            </span>
            ...
            <p className='hover:text-secondary fill-white w-max hover:fill-secondary mt-14 transition-all duration-300'>
              <Link to={'/portfolio'} className='learn-more-link flex items-center relative font-medium text-lg'>
      ...
      <section className='container px-4 mx-auto'>
        ...
        <div className='py-20 fade-in-section'>
          <div className='flex flex-col items-center'>
            <h1 className='font-cairo font-bold text-center text-4xl mt-10 text-[#66e0ff] neon-underline'>
              Get To Know Me
            </h1>
        ...
        <div className='py-20 fade-in-section'>
          <div className='flex flex-col items-center'>
            <h1 className='font-cairo font-bold text-4xl mt-10 text-center text-[#66e0ff] neon-underline'>
        ...
        <div className='py-20 fade-in-section'>
          ...
          <div className='hidden md:flex md:flex-wrap justify-center items-center gap-20'>
            <ProjectCard
              title='Cyber Threat Intelligence Dashboard'
              techStack={['React.js', 'Tailwind CSS', 'FastAPI', 'Python', 'JavaScript', 'Vite']}
              description='Developed a real-time threat intelligence dashboard using React.js and FastAPI. Features include live threat data visualization, IP geolocation tracking, and secure API endpoints, all hosted on Render with CORS-enabled backend for seamless frontend-backend communication.'
              demoLink='https://cyber-threat-dashboard-3mz9.onrender.com'
              codeLink='https://github.com/KrishRio21/Cyber-Threat_Dashboard'
            />
        ...
        <div className='py-20 text-center flex flex-col items-center'>
          <h1 className='font-cairo text-3xl md:text-[40px] font-semibold'>
          ...
          <img
            src={zigzagLine}
            alt='zigzag-line'
            className='w-48 sm:w-56 md:w-80 mt-10 -skew-x-[20deg]'
          />
        </div>
